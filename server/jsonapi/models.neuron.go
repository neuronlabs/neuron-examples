...
func (b *Blog) SetRelationModel(relation *mapping.StructField, model mapping.Model) error {
	...
	case 4: // TopPost
		...
		return errors.Newf(mapping.ClassInvalidRelationValue, "provided invalid model value: '%T' for relation TopPost", model)
	default:
...
func (c *Comment) GetRelationModel(relation *mapping.StructField) (mapping.Model, error) {
	...
	case 2: // Post
		...
		return c.Post, nil
	default:
		return nil, errors.Newf(mapping.ClassInvalidRelationField, "provided invalid relation: '%s' for model: '%T'", relation, c)
	}
}
...
func (c *Comment) SetRelationModel(relation *mapping.StructField, model mapping.Model) error {
	...
	case 2: // Post
		...
		return errors.Newf(mapping.ClassInvalidRelationValue, "provided invalid model value: '%T' for relation Post", model)
	default:
		return errors.Newf(mapping.ClassInvalidRelationField, "provided invalid relation: '%s' for model: '%T'", relation, c)
	}
}
...
func (p *Post) SetRelationModel(relation *mapping.StructField, model mapping.Model) error {
	...
	case 4: // Blog
		...
		return errors.Newf(mapping.ClassInvalidRelationValue, "provided invalid model value: '%T' for relation Blog", model)
	default:
