...
func (b *_Blogs) InitializeCollection(_ctrl *controller.Controller) error {
...
func (b *_Blogs) AddPosts(ctx context.Context, db database.DB, model *Blog, relations ...*Post) error {
	...
	if !ok {
		return errors.NewDetf(query.ClassInternal, "DB doesn't implement QueryRelationAdder interface - %T", db)
	}
...
func (b *_Blogs) ClearPostsRelation(ctx context.Context, db database.DB, models ...*Blog) (int64, error) {
	...
	if !ok {
		return 0, errors.NewDetf(query.ClassInternal, "DB doesn't implement QueryRelationAdder interface - %T", db)
	}
...
func (b *_Blogs) GetPosts(ctx context.Context, db database.DB, model *Blog, relationFieldset ...string) ([]*Post, error) {
	...
	if model.IsPrimaryKeyZero() {
		return nil, errors.New(mapping.ClassFieldValue, "model's: 'Blog' primary key value has zero value")
	}
	relationField, err := b.Model.RelationByIndex(3)
	if err != nil {
		return nil, err
	...
	if len(relationFieldset) == 0 {
		...
		for _, field := range relationFieldset {
			...
			if !ok {
				return nil, errors.Newf(mapping.ClassInvalidModelField, "no field: '%s' found for the model: 'Post'", field)
			}
...
func (b *_Blogs) SetPosts(ctx context.Context, db database.DB, model *Blog, relations ...*Post) error {
	...
	// Check if primary key has zero value.
	if model.IsPrimaryKeyZero() {
		return errors.New(mapping.ClassFieldValue, "model's: 'Blog' primary key value has zero value")
	}
	relationField, err := b.Model.RelationByIndex(3)
	if err != nil {
		return err
	...
	for i, relation := range relations {
		if relation.IsPrimaryKeyZero() {
			return errors.New(mapping.ClassFieldValue, "one of relation 'Posts' model has zero value primary field")
		}
		relationModels[i] = relation
	}
	relationSetter, ok := db.(database.QueryRelationSetter)
	if !ok {
		return errors.NewDetf(query.ClassInternal, "DB doesn't implement QueryRelationSetter interface: %T", db)
	}
...
func (b *_Blogs) SetTopPost(ctx context.Context, db database.DB, model *Blog, relation *Post) error {
	...
	q := query.NewScope(b.Model, model)
	if relation.IsPrimaryKeyZero() {
		return errors.New(mapping.ClassFieldValue, "relation 'TopPost' model has zero value primary field")
	}
	relationSetter, ok := db.(database.QueryRelationSetter)
	if !ok {
		return errors.NewDetf(query.ClassInternal, "DB doesn't implement QueryRelationSetter interface: %T", db)
...
func (b *blogsQueryBuilder) IncludePosts(postsFieldset ...string) *blogsQueryBuilder {
	...
	if err != nil {
		b.err = errors.Newf(mapping.ClassInternal, "Getting 'Posts' by index for model 'Blog' failed: %v", err)
		return b
	}
	...
	for _, field := range postsFieldset {
		...
		if !ok {
			b.err = errors.Newf(mapping.ClassInvalidModelField, "field: '%s' is not found for the 'Post' model", field)
			return b
		}
...
func (b *blogsQueryBuilder) IncludeTopPost(topPostFieldset ...string) *blogsQueryBuilder {
	...
	if err != nil {
		b.err = errors.Newf(mapping.ClassInternal, "Getting 'TopPost' by index for model 'Blog' failed: %v", err)
		return b
	}
	// check the fieldset for the relation.
	var relationFields []*mapping.StructField
...
func (b *blogsQueryBuilder) Select(fields ...string) *blogsQueryBuilder {
	...
	for _, field := range fields {
		...
		if !ok {
			b.err = errors.Newf(mapping.ClassInvalidModelField, "field: '%s' is not valid for model: '_Blogs'", field)
			return b
		}
...
func (b *blogsQueryBuilder) OrderBy(fields ...string) *blogsQueryBuilder {
	...
	for i, field := range fields {
		if len(field) == 0 {
			b.err = errors.New(mapping.ClassInvalidModelField, "cannot set sorting order for an empty field for model: '_Blogs'")
			return b
		}
...
func (b *blogsQueryBuilder) AddPosts(_posts ...*Post) error {
	...
	relation, err := NRN_Blogs.Model.RelationByIndex(3)
	if err != nil {
		return errors.Newf(mapping.ClassInternal, "getting 'Posts' relation by index for model 'Blog' failed: %v", err)
	}
...
func (b *blogsQueryBuilder) AddTopPost(_topPost *Post) error {
	...
	relation, err := NRN_Blogs.Model.RelationByIndex(4)
	if err != nil {
		return errors.Newf(mapping.ClassInternal, "getting 'TopPost' relation by index for model 'Blog' failed: %v", err)
	}
...
func (b *blogsQueryBuilder) RemovePosts() (int64, error) {
	...
	relation, err := NRN_Blogs.Model.RelationByIndex(3)
	if err != nil {
		return 0, errors.Newf(mapping.ClassInternal, "getting 'Posts' relation by index for model 'Blog' failed: %v", err)
	}
...
func (b *blogsQueryBuilder) RemoveTopPost() (int64, error) {
	...
	relation, err := NRN_Blogs.Model.RelationByIndex(4)
	if err != nil {
		return 0, errors.Newf(mapping.ClassInternal, "getting 'TopPost' relation by index for model 'Blog' failed: %v", err)
	}
	return b.builder.RemoveRelations(relation)
}
...
// InitializeCollection implements database.Collection interface.
func (c *_Comments) InitializeCollection(_ctrl *controller.Controller) error {
...
func (c *_Comments) GetPost(ctx context.Context, db database.DB, model *Comment, relationFieldset ...string) (*Post, error) {
	...
	// Check if primary key has zero value.
	if model.IsPrimaryKeyZero() {
		return nil, errors.New(mapping.ClassFieldValue, "model's: 'Comment' primary key value has zero value")
	}
...
func (c *_Comments) SetPost(ctx context.Context, db database.DB, model *Comment, relation *Post) error {
	...
	// Check if primary key has zero value.
	if model.IsPrimaryKeyZero() {
		return errors.New(mapping.ClassFieldValue, "model's: 'Comment' primary key value has zero value")
	}
	relationField, err := c.Model.RelationByIndex(2)
	if err != nil {
		return err
	...
	if relation.IsPrimaryKeyZero() {
		return errors.New(mapping.ClassFieldValue, "relation 'Post' model has zero value primary field")
	}
	relationSetter, ok := db.(database.QueryRelationSetter)
	if !ok {
		return errors.NewDetf(query.ClassInternal, "DB doesn't implement QueryRelationSetter interface: %T", db)
...
func (c *commentsQueryBuilder) IncludePost(postFieldset ...string) *commentsQueryBuilder {
	...
	if err != nil {
		c.err = errors.Newf(mapping.ClassInternal, "Getting 'Post' by index for model 'Comment' failed: %v", err)
		return c
	}
	// check the fieldset for the relation.
	var relationFields []*mapping.StructField
	for _, field := range postFieldset {
		structField, ok := relation.ModelStruct().FieldByName(field)
		if !ok {
			c.err = errors.Newf(mapping.ClassInvalidModelField, "field: '%s' is not found for the 'Post' model", field)
			return c
		}
		relationFields = append(relationFields, structField)
	}
...
func (c *commentsQueryBuilder) Select(fields ...string) *commentsQueryBuilder {
	...
	for _, field := range fields {
		...
		if !ok {
			c.err = errors.Newf(mapping.ClassInvalidModelField, "field: '%s' is not valid for model: '_Comments'", field)
			return c
		}
		fieldSet = append(fieldSet, structField)
	}
...
func (c *commentsQueryBuilder) OrderBy(fields ...string) *commentsQueryBuilder {
	...
	for i, field := range fields {
		if len(field) == 0 {
			c.err = errors.New(mapping.ClassInvalidModelField, "cannot set sorting order for an empty field for model: '_Comments'")
			return c
		}
		var order query.SortOrder
		if field[0] == '-' {
...
func (c *commentsQueryBuilder) AddPost(_post *Post) error {
	...
	relation, err := NRN_Comments.Model.RelationByIndex(2)
	if err != nil {
		return errors.Newf(mapping.ClassInternal, "getting 'Post' relation by index for model 'Comment' failed: %v", err)
	}
...
func (c *commentsQueryBuilder) RemovePost() (int64, error) {
	...
	relation, err := NRN_Comments.Model.RelationByIndex(2)
	if err != nil {
		return 0, errors.Newf(mapping.ClassInternal, "getting 'Post' relation by index for model 'Comment' failed: %v", err)
	}
...
// InitializeCollection implements database.Collection interface.
func (p *_Posts) InitializeCollection(_ctrl *controller.Controller) error {
...
func (p *_Posts) GetBlog(ctx context.Context, db database.DB, model *Post, relationFieldset ...string) (*Blog, error) {
	...
	// Check if primary key has zero value.
	if model.IsPrimaryKeyZero() {
		return nil, errors.New(mapping.ClassFieldValue, "model's: 'Post' primary key value has zero value")
	}
	...
	if len(relationFieldset) == 0 {
		...
		for _, field := range relationFieldset {
			sField, ok := relationModel.FieldByName(field)
			if !ok {
				return nil, errors.Newf(mapping.ClassInvalidModelField, "no field: '%s' found for the model: 'Blog'", field)
			}
			fields = append(fields, sField)
		}
	}
...
func (p *_Posts) SetBlog(ctx context.Context, db database.DB, model *Post, relation *Blog) error {
	...
	// Check if primary key has zero value.
	if model.IsPrimaryKeyZero() {
		return errors.New(mapping.ClassFieldValue, "model's: 'Post' primary key value has zero value")
	}
	relationField, err := p.Model.RelationByIndex(4)
	if err != nil {
		return err
	...
	if relation.IsPrimaryKeyZero() {
		return errors.New(mapping.ClassFieldValue, "relation 'Blog' model has zero value primary field")
	}
	relationSetter, ok := db.(database.QueryRelationSetter)
	if !ok {
		return errors.NewDetf(query.ClassInternal, "DB doesn't implement QueryRelationSetter interface: %T", db)
...
func (p *_Posts) GetComments(ctx context.Context, db database.DB, model *Post, relationFieldset ...string) ([]*Comment, error) {
	...
	if len(relationFieldset) == 0 {
		...
		for _, field := range relationFieldset {
			sField, ok := relationModel.FieldByName(field)
			if !ok {
				return nil, errors.Newf(mapping.ClassInvalidModelField, "no field: '%s' found for the model: 'Comment'", field)
			}
			fields = append(fields, sField)
		}
	}
...
func (p *_Posts) SetComments(ctx context.Context, db database.DB, model *Post, relations ...*Comment) error {
	...
	for i, relation := range relations {
		if relation.IsPrimaryKeyZero() {
			return errors.New(mapping.ClassFieldValue, "one of relation 'Comments' model has zero value primary field")
		}
		relationModels[i] = relation
	}
	relationSetter, ok := db.(database.QueryRelationSetter)
...
func (p *postsQueryBuilder) IncludeBlog(blogFieldset ...string) *postsQueryBuilder {
	...
	if err != nil {
		p.err = errors.Newf(mapping.ClassInternal, "Getting 'Blog' by index for model 'Post' failed: %v", err)
		return p
	}
	// check the fieldset for the relation.
	var relationFields []*mapping.StructField
	for _, field := range blogFieldset {
		structField, ok := relation.ModelStruct().FieldByName(field)
		if !ok {
			p.err = errors.Newf(mapping.ClassInvalidModelField, "field: '%s' is not found for the 'Blog' model", field)
			return p
		}
		relationFields = append(relationFields, structField)
	}
...
func (p *postsQueryBuilder) IncludeComments(commentsFieldset ...string) *postsQueryBuilder {
	...
	if err != nil {
		p.err = errors.Newf(mapping.ClassInternal, "Getting 'Comments' by index for model 'Post' failed: %v", err)
		return p
	}
	// check the fieldset for the relation.
	var relationFields []*mapping.StructField
	for _, field := range commentsFieldset {
		structField, ok := relation.ModelStruct().FieldByName(field)
		if !ok {
			p.err = errors.Newf(mapping.ClassInvalidModelField, "field: '%s' is not found for the 'Comment' model", field)
			return p
		}
		relationFields = append(relationFields, structField)
	}
...
func (p *postsQueryBuilder) Select(fields ...string) *postsQueryBuilder {
	...
	for _, field := range fields {
		...
		if !ok {
			p.err = errors.Newf(mapping.ClassInvalidModelField, "field: '%s' is not valid for model: '_Posts'", field)
			return p
		}
		fieldSet = append(fieldSet, structField)
	}
...
func (p *postsQueryBuilder) OrderBy(fields ...string) *postsQueryBuilder {
	...
	for i, field := range fields {
		if len(field) == 0 {
			p.err = errors.New(mapping.ClassInvalidModelField, "cannot set sorting order for an empty field for model: '_Posts'")
			return p
		}
		var order query.SortOrder
		if field[0] == '-' {
...
func (p *postsQueryBuilder) AddBlog(_blog *Blog) error {
	...
	relation, err := NRN_Posts.Model.RelationByIndex(4)
	if err != nil {
		return errors.Newf(mapping.ClassInternal, "getting 'Blog' relation by index for model 'Post' failed: %v", err)
	}
...
func (p *postsQueryBuilder) AddComments(_comments ...*Comment) error {
	...
	relation, err := NRN_Posts.Model.RelationByIndex(6)
	if err != nil {
		return errors.Newf(mapping.ClassInternal, "getting 'Comments' relation by index for model 'Post' failed: %v", err)
	}
...
func (p *postsQueryBuilder) RemoveBlog() (int64, error) {
	...
	relation, err := NRN_Posts.Model.RelationByIndex(4)
	if err != nil {
		return 0, errors.Newf(mapping.ClassInternal, "getting 'Blog' relation by index for model 'Post' failed: %v", err)
	}
...
func (p *postsQueryBuilder) RemoveComments() (int64, error) {
	...
	relation, err := NRN_Posts.Model.RelationByIndex(6)
	if err != nil {
		return 0, errors.Newf(mapping.ClassInternal, "getting 'Comments' relation by index for model 'Post' failed: %v", err)
	}
	return p.builder.RemoveRelations(relation)
}
